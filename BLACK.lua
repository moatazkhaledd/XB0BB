...
--]]
database = dofile("./BLA/redis.lua").connect("127.0.0.1", 6379)
serpent = dofile("./BLA/serpent.lua")
JSON    = dofile("./BLA/dkjson.lua")
json    = dofile("./BLA/JSON.lua")
URL     = dofile("./BLA/url.lua")
...
if hash or DevBLACK(msg) or DevBOYKAW(msg) then  
return true  
else  
return false  
end  
...
if hash or DevBLACK(msg) or DevBOYKAW(msg)  or DevBot(msg) then 
return true 
else 
return false 
end 
...
if hash or DevBLACK(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevBLACK(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevBLACK(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or DevBLACK(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
for BLACK in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = BLACK
end
...
local BLACK_Msg = database:get(bot_id.."BLACK:Add:Filter:Rp2"..text..msg.chat_id_)   
if BLACK_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","◍ "..BLACK_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_BLACK, nil)
return false
end
------------------------------------------------------------------------
...
if text == 'تفعيل all' and DevBLACK(msg) then   
...
if text == 'تعطيل all' and DevBLACK(msg) then  
...
local list = database:smembers(bot_id.."BLACK:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BLACK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BLACK:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BLACK:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n◍ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local BLACK_Msg = database:get(bot_id.."BLACK:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BLACK_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."BLACK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BLACK:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BLACK:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."BLACK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BLACK:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BLACK:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BLACK:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."BLACK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BLACK:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BLACK:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
------------------------------------------------------------------------
if text == ("مسح الردود العامه") and DevBLACK(msg) then 
...
if text == ("الردود العامه") and DevBLACK(msg) then 
local list = database:smembers(bot_id.."BLACK:List:Rd:Sudo")
text = "\n◍ قائمة الردود العامه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if text == "اضف رد عام" and DevBLACK(msg) then 
send(msg.chat_id_, msg.id_,"◍ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."BLACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد عام" and DevBLACK(msg) then 
send(msg.chat_id_, msg.id_,"◍ ارسل الكلمه التري تريد حذفها")
...
if text == ("مسح الردود المتعدده") and DevBLACK(msg) then
...
------------
if text == ("الردود المتعدده") and DevBLACK(msg) then
local list = database:smembers(bot_id.."botss:DRAGON:List:Rd:Sudo")
text = "\nقائمة ردود المتعدده \nٴ≪┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
db = "رساله "
...
if text == "اضف رد متعدد" and DevBLACK(msg) then
...
if text == "حذف رد متعدد" and DevBLACK(msg) then
...
if database:sismember(bot_id.."BLACK:Sudo:User",result.id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."BLACK:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."BLACK:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."BLACK:Manager"..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."BLACK:Mod:User"..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."BLACK:Special:User"..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
...
if database:sismember(bot_id.."BLACK:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."BLACK:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."BLACK:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."BLACK:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."BLACK:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."BLACK:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
if text == "رتبتي" then
local rtp = database:get(bot_id.."BLACK:Comd:New:rt:User:"..msg.chat_id_..msg.sender_user_id_) or Get_Rank(msg.sender_user_id_,msg.chat_id_)
...
database:del(bot_id..'BLACK:Lock:Added:Me'..msg.chat_id_)  
send(msg.id_,'◍ تم تفعيل امر منو ضافني') 
return false
end
if text == 'تعطيل مين ضافني' and Owner(msg) then  
database:set(bot_id..'BLACK:Lock:Added:Me'..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,'◍ تم تعطيل امر مين ضافني') 
return false
end

if text and text:match("(.*)(مين ضافني)(.*)") then
if not database:get(bot_id..'BLACK:Lock:Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'◍ انت منشئ المجموعه ') 
return false
end
local Added_Me = database:get(bot_id.."BLACK:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
-------
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBLACK(msg) then
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and DevBLACK(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and DevBLACK(msg) then
...
if text == ("تنزيل مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBLACK(msg) then
function Function_BOYKA(extra, result, success)
...
if text and text:match("^تنزيل مطور ثانوي @(.*)$") and DevBLACK(msg) then
...
if text and text:match("^تنزيل مطور ثانوي (%d+)$") and DevBLACK(msg) then
...
if text == ("مسح الثانويين") and DevBLACK(msg) then
...
database:sadd(bot_id.."BLACK:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end
...
if text == (database:get(bot_id.."BLACK:Name:Bot") or "جوكر") then
Namebot = (database:get(bot_id.."BLACK:Name:Bot") or "جوكر")
local namebot = {
'◍ يوه '..Namebot..' زهق منك😒',
'◍ نعم ياعيون '..Namebot..' 😻💓',
'◍ عايز اي من '..Namebot..' 🙄💛',
...
if database:get(bot_id.."BLACK:Status:Bc") and not DevBOYKAW(msg) then 
...
if text == 'صورتي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'BLACK:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'BLACK:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."BLACK:Spam:Group"..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,taha,success) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'BLACK:Lock:ID:Bot'..msg.chat_id_) then
...
if text == "مسح المشتركين" and DevBLACK(msg) then
...
if text == "مسح الجروبات" and DevBLACK(msg) then
...
download_to_file('https://raw.githubusercontent.com/jaxso0n/jaxson/master/BLACK.lua', 'BLACK.lua') 
...
t = t..'}}'
local File = io.open('./BLA/'..bot_id..'.json', "w")
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,'./BLA/'..bot_id..'.json', '◍ عدد مجموعات التي في البوت { '..#list..'}')
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/jaxso0n/jaxson/master/files_BLACK/"..file)
if res == 200 then
...
local list1 = database:smembers('BLACK:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."BLACK:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('BLACK:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."BLACK:Constructor"..Groups[i], v)
end
local list3 = database:smembers('BLACK:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."BLACK:Manager"..Groups[i], v)
end
local list4 = database:smembers('BLACK:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."BLACK:Mod:User"..Groups[i], v)
end
database:set(bot_id.."BLACK:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'BLACK:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
...
database:set(bot_id..'BLACK:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'◍ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'BLACK:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'BLACK:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
...
send(msg.chat_id_, msg.id_, t..'═───═𝐌𝐈𝐋𝐀𝐍═───═\n◍ CH - [『 𝐒𝐎𝗨𝐑𝐂𝐄 𝐌𝐈𝐋𝐀𝐍 』](t.me/SORMILAN)  ')
end
...
{
{text = '◍ 𝙳𝙴𝚅 𝙼𝙾𝙰𝚃𝙰𝚉', url = "https://t.me/XB0BB"}
},
{
{text = '◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂', url = "https://t.me/SORMILAN"}
},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𝐃𝐄𝐕 𝐌𝐎𝐀𝐓𝐀𝐙', url = "https://t.me/XB0BB"}
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ● رابط حذف تيلجرام ●.',url="https://my.telegram.org/auth?to=delete"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تابع جديدنا من فضلك ',url="t.me/sormilan"}}, 
{{text = 'لشراء نسخة من البوت ',url="t.me/xb0bb"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:set(bot_id.."BLACK:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◍ اليك الاوامر الخاص بسورس ميلآن .
...
database:del(bot_id.."BLACK:Link_Group"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."BLACK:Chek:Welcome"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLACK:Reply:Sudo"..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'BLACK:Lock:ID:Bot'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'BLACK:Lock:ID:Bot:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLACK:Kick:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLACK:Reply:Manager"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLACK:Link_Group"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLACK:Chek:Welcome"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."BLACK:Reply:Sudo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'BLACK:Lock:ID:Bot'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'BLACK:Lock:ID:Bot:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."BLACK:Kick:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."BLACK:Reply:Manager"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLACK:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:User:Name"..Chat_id,"del") 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Sticker"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Animation"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Video"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Photo"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Audio"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:vico"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Document"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Contact"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Spam"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hset(bot_id.."BLACK:flooding:settings:"..Chat_id ,"flood","del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLACK:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:AddMempar"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:text"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Join"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Bot:kick"..Chat_id)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:edit"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Link"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Spam"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hdel(bot_id.."BLACK:flooding:settings:"..Chat_id ,"flood")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLACK:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id..'BLACK:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n تم تعطيل تحقق' ) 
end
if text == 'تفعيل تحقق' and Addictive(msg) then  
database:set(bot_id..'BLACK:nwe:mem:group'..msg.chat_id_,'true') 
send(msg.chat_id_, msg.id_,'\nتم تفعيل تحقق' ) 
end 

if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'BLACK:nwe:mem:group'..msg.chat_id_) == 'true'then
numphoto = {'3','8','9','6'}
...
local Name_Bot = (database:get(bot_id.."BLACK:Name:Bot") or "جوكر")
...
------------------------------------------------------------------------
if text then
local BLACK_Msg = database:get(bot_id.."BLACK:Add:Filter:Rp2"..text..result.chat_id_)   
if BLACK_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","◍ "..BLACK_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
