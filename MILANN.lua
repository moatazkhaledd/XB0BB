...
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/SrcDrg)}\n ℘︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](T.ME/SrcDrg)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.',url="t.me/SrcDrg"}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𝐌𝐈𝐋𝐀𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/SORMILAN"},
},
}
local msg_id = msg.id_/2097152/0.5
